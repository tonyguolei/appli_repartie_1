        ...
        while (true) {
            ...
            switch (cmd) {
                ...
                case "master":
                    ...
                    break;
                case "neighborBehind":
                    System.out.println("Mon voisin derriere est " + neighborServerBehindMe[0]
                            + " à l'adresse " + neighborServerBehindMe[1]
                            + " sur le port " + neighborServerBehindMe[2]);
                    break;
                case "neighborFront":
                    System.out.println("Mon voisin devant est " + neighborServerFrontMe[0]
                            + " à l'adresse " + neighborServerFrontMe[1]
                ...
                case "help":
                    ...
                    System.out.println("-unfinishedGame         Afficher les parties non terminés");
                    break;
                default:
